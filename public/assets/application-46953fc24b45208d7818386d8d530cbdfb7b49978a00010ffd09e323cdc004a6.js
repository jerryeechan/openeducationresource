...
var appId = '1066169166749657';
  

$(document).on('ready page:load', function () {
//development id
  console.log('logout bind');
...
(function($){
  ...
  window.hackpad = function(){
    ...
    function render(targetElement, padId, optSubDomain) {
      ...
      var url = "https://" + subDomain + "hackpad.com/ep/api/embed-pad";
    ...
    $.widget("ui.tagit", {
        ...
        _create: function () {
            ...
            $(this.element).click(function (e) {
                if ($(e.target).hasClass('tagit-close')) {
                    ...
                    if(tag=== undefined){
                        $('#showlist').children()[parent.index()].remove();
                    }else{
                        tag.element.remove();
                        self._popTag(tag);
                    }
        ...
        _processKeyEvent: function (e) {
            ...
            if (this._isInitKey(pressedKey) && !(this._isTabKey(pressedKey) && this.value === '' && !this.input.data('autoCompleteTag'))) {
                ...
                if (!this.options.allowNewTags || (this.options.maxTags !== undefined && this.tagsArray.length === this.options.maxTags)) {
                    ...
                    this._addTag({ label: this.input.val(), value: this.input.val(),type: this.options.defaultType});
                }
            }
        ...
        _addTag: function (newTag) {
            ...
            tag.element = $('<li class="tagit-choice'
                ...
                + '<div class="tagit-label">' + newTag.value + '</div>' + '<a class="tagit-close">x</a></li>');
            ...
            if (this.options.initialTags.length !== 0) {
                $(this.options.initialTags).each(function (i, element) {
                    if (typeof element === "object") {
                        ...
                        input._addTag({ abel: element.label, value: element.label, type: element.type });
                    }
                });
            }
